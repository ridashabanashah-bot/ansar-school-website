...
export interface ApiAboutPageAboutPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    principalMessage: Schema.Attribute.Text;
    principalName: Schema.Attribute.String;
    principalPhoto: Schema.Attribute.Media<'images'>;
    publishedAt: Schema.Attribute.DateTime;
    seo: Schema.Attribute.Component<'shared.seo', false>;
    title: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'About Our School'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiAcademicsPageAcademicsPage extends Struct.SingleTypeSchema {
  collectionName: 'academics_pages';
  info: {
    displayName: 'Academics Page';
    pluralName: 'academics-pages';
    singularName: 'academics-page';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    facilities: Schema.Attribute.Component<'academics.facility', true>;
    intro: Schema.Attribute.Text;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::academics-page.academics-page'
    > &
      Schema.Attribute.Private;
    programs: Schema.Attribute.Component<'academics.program', true>;
    publishedAt: Schema.Attribute.DateTime;
    seo: Schema.Attribute.Component<'shared.seo', false>;
    title: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Academics'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiAdmissionsPageAdmissionsPage
  ...
  attributes: {
    ageEligibility: Schema.Attribute.Text;
    applicationForm: Schema.Attribute.Media<'files'>;
    ...
    > &
      Schema.Attribute.Private;
    process: Schema.Attribute.Component<'admissions.step', true>;
    publishedAt: Schema.Attribute.DateTime;
    seo: Schema.Attribute.Component<'shared.seo', false>;
    title: Schema.Attribute.String &
      Schema.Attribute.Required &
...
export interface ApiDocumentDocument extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Official documents (certificates, fee structure, calendars, sample TCs, etc.).';
...
export interface ApiNewsArticleNewsArticle extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'School news, announcements, achievements.';
...
export interface ApiPagePage extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Generic content page (about, policy, info, facilities, \u2026) migrated from the legacy site.';
    displayName: 'Page';
    pluralName: 'pages';
    singularName: 'page';
  };
...
export interface ApiSiteSettingSiteSetting extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Global site settings: school name, contact info, social links.';
  ...
  attributes: {
    ...
    schoolName: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Ansar School Padhinjarangadi'>;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::academics-page.academics-page': ApiAcademicsPageAcademicsPage;
